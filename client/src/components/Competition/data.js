...
const pitch = `${aws}/pitch.jpg`;
const bizminds = `${aws}/bizminds.jpg`;
const ideathon = `${aws}/ideathon.jpg`;
const casecraft = `${aws}/casecraft.jpg`;
const trading = `${aws}/trading.jpg`;
const sustainathon = `${aws}/sustainathon.jpg`;
const starpix = `${aws}/starpix.jpg`;
const lnmhacks = `${aws}/lnmhacks.jpg`;
const bgmi = `${aws}/bgmi.jpg`;
const codm = `${aws}/codm.jpg`;
const clashroyale = `${aws}/clashroyale.jpg`;
const valorant = `${aws}/valorant.jpg`;
const freefire = `${aws}/freefire.jpg`;
const beatlab = `${aws}/beatlab.jpg`;
const gamesmith = `${aws}/gamesmith.jpg`;
const creatifrenzy = `${aws}/creatifrenzy.jpg`;
const djbattle = `${aws}/djbattle.jpg`;
const odinseye = `${aws}/odinseye.jpg`;
const motoboat = `${aws}/motoboat.jpg`;
const cubeopen = `${aws}/cubeopen.jpg`;
const cyberolympiad = `${aws}/cyberolympiad.jpg`;
const telescope = `${aws}/telescope.jpg`;
const data = {
  Quizzing: [
    {
      id: 1,
