...
const Footer = () => {
  return (
    <div className="w-full realtive flex-col flex-wrap text-white ">
      <div className="flex flex-wrap w-full justify-around items-center p-10 bg-[#141414] ">
        <div className="flex-col flex gap-5">
          <h2 className="text-centerfont-poppins font-normal tracking-[0.16em] text-2xl md:text-4xl sm:text-lg">
            Get In Touch
          </h2>
          <div className="flex justify-evenly">
            ...
            <a href="mailto:plinth@lnmiit.ac.in">
              <img src={Web} alt="Web" className="w-6 h-6 sm:w-5 sm:h-5" />
            </a>
          </div>
        ...
        <img
          src={plinthtext2}
          alt="Plinth Text"
          className="w-[200px] h-[80px] md:w-[286px] md:h-[89px] sm:w-[180px] sm:h-[156px]"
        />
