      ...
      <div className="md:block hidden">
        <div className="w-[100%] aspect-[1728/3351]  bg-black relative overflow-x-hidden">
          ...
          <div className="w-full  ">
            <div
              className="w-[44.76%] h-[49.45%] top-[35.31%] left-[56.47%] flex flex-col absolute "
              style={{
                rotate: "-3.97deg",
              }}
            >
            ...
            <div className="">
              <p className="absolute top-[48%] w-[44.76%] left-[58.47%] c1:text-[4rem] 2xl:text-[1.8rem] xl:text-[2rem] lg:text-[1.3rem] md:text-[1.3rem] sm:text-[1.2rem] xsm:text-[1rem] text-white font-melete font-[400]">
                JAN 25,2025
              </p>
            </div>
            ...
            <div className="rotate-[-5.9deg] z-20 w-[89.21vw] h-[2.09vh] absolute top-[72.9%] left-[9%] c1:text-[4rem] 2xl:text-[3.8rem] xl:text-[2.9rem] lg:text-[2.6rem] md:text-[1.8rem] sm:text-[1.5rem] xsm:text-[1.3rem] text-white font-melete font-[400] ">
              SUNBURN CAMPUS
            </div>
          ...
          <div className="w-full h-auto ">
            ...
            <div className="absolute top-[93%] left-[32.06%]">
              <p className="c1:text-[4rem] 2xl:text-[1.8rem] xl:text-[2rem] lg:text-[1.3rem] md:text-[1.3rem] sm:text-[1.2rem] xsm:text-[1rem] text-white font-melete font-[400]">
                JAN 26,2025
              </p>
            </div>
            <div className="absolute w-[68%] h-[1.22%] top-[104.99%] left-[19.09%]">
              <p className="c1:text-[4rem] 2xl:text-[2.5rem] xl:text-[2.0rem] lg:text-[2.4rem] md:text-[1.7rem] sm:text-[1.2rem] xsm:text-[1rem] text-white font-melete font-[400]">
                REVEALING SOON
              </p>
            </div>
            ...
            <div className="rotate-[3.2deg] z-20 absolute top-[124.4%] left-[9%] c1:text-[4rem] 2xl:text-[3.8rem] xl:text-[2.3rem] lg:text-[2.5rem] md:text-[1.9rem] sm:text-[1.5rem] xsm:text-[1.3rem] text-white font-melete font-[400] ">
              BOLLYWOOD NIGHT
            </div>
