...
const Sidebar = () => {
  ...
  return (
    <div
      ...
      className="2xl:w-[4rem] xl:w-[4rem] lg:w-[4rem] md:w-[3rem] sm:w-[3rem] min-h-[80vh] flex flex-col justify-start items-center bg-white/5 backdrop-blur-sm fixed top-[8rem] z-20 left-6 text-center"
    >
