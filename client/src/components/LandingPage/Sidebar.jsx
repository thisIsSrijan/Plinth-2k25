...
const Sidebar = () => {
  ...
  return (
    <div className="fixed h-[100vh] my-auto left-6 z-20 group flex flex-col justify-center items-center">
        ...
        <div
          ...
          className="flex flex-col justify-start items-start bg-white/5 backdrop-blur-md text-center transition-all duration-500 ease-in-out hover:w-56 w-16 overflow-hidden"
        >
