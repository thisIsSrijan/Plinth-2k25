        ...
        <div className="w-full uxsm:h-full md:h-full bg-black overflow-hidden">
            ...
            <div className="flex flex-col justify-center text-center items-center uxsm:mt-40 md:mt-0  w-full">
                <div className="flex flex-col justify-center items-center relative mt-[8rem]">
                    ...
                    <div  className="c1:text-[4rem] 2xl:text-[2.5rem] xl:text-[2.3rem] lg:text-[2rem] md:text-[1.8rem] sm:text-[1.7rem] xsm:text-[1.3rem] uxsm:text-[1.2rem]  greencolor md:mt-[6rem] uxsm:mt-[8rem] font-melete">24-26 JAN 2025</div>
                    <div  className="flex c1:text-[3.5rem] 2xl:text-[2rem] xl:text-[1.8rem] lg:text-[1.5rem] md:text-[1.3rem] sm:text-[1.4rem] xsm:text-[0.8rem] uxsm:text-[0.7rem] text-white greycolor font-melete"><span className="greycolor"><IoLocationOutline className=" c1:text-[4rem] xl:text-[2.5rem] lg:text-[2rem] md:text-[2rem] sm:text-[1.5rem] xsm:text-[1.5rem] uxsm:text-[1rem]"></IoLocationOutline></span>LNMIIT,JAIPUR</div>
