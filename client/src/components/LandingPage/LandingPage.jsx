...
const LandingPage = () => {
    ...
    return (
      <div className="w-full min-h-[100vh] uxsm:h-full md:h-full bg-black overflow-hidden flex flex-col justify-center items-center ">
        ...
        <motion.div
          className="c1:text-[4rem] 2xl:text-[2.5rem] xl:text-[2.3rem] lg:text-[2rem] md:text-[1.8rem] xsm:text-[1.2rem] text-[0.8rem] greencolor md:mt-[6rem] uxsm:mt-[8rem] font-melete relative"
        ...
        <motion.div
          className="flex c1:text-[3.5rem] 2xl:text-[2rem] xl:text-[1.8rem] lg:text-[1.5rem] md:text-[1.3rem] sm:text-[1.4rem] xsm:text-[0.8rem] uxsm:text-[0.7rem] text-white greycolor font-melete relative"
          variants={letterContainer}
          initial="hidden"
          animate="visible"
          transition={{ delay: 5 }}
    ...
    hover:text-[#A7F818] hover:shadow-[inset_0_0_20px_#A7F818,0_0_40px_#A7F818]"
          ...
          <motion.div
          className="uxsm:w-full absolute uxsm:right-[3.5rem] xsm:right-[5rem] md:-left-[30rem] lg:right-[10rem] xl:right-[13rem] 2xl:right-[15rem] uxl:-left-[40rem] c1:-left-[50rem] font-melete lg:mt-[8rem] md:mt-[6rem] sm:mt-[1rem] xsm:mt-[0rem] uxsm:mt-[0rem] mb-[5rem] c1:text-[2.3rem] 2xl:text-[1.8rem] xl:text-[1.5rem] lg:text-[1.3rem] md:text-[1.1rem] sm:text-[0.9rem] uxsm:text-[0.6rem] ml-[20rem] flex justify-end items-end greycolor"
