...
const LandingPage = () => {
      ...
      <div className="w-full min-h-[100vh] uxsm:h-full md:h-full bg-black overflow-hidden flex flex-col justify-center items-center ">
        ...
        <div className="flex flex-col justify-center text-center items-center uxsm:mt-40 md:mt-0  w-full">
          <div className="flex flex-col justify-center items-center relative mt-[8rem] ">
            <div
              className="absolute font-cynatar uxsm:text-s tracking-wide  w-[90rem] c1:text-[20rem] 2xl:text-[15rem] xl:text-[13rem] lg:text-[12rem] md:text-[9rem] sm:text-[8rem] xsm:text-[5rem] uxsm:text-[4.2rem] font-[400] textfamily  plinth hero glitch layers"
              data-text="PLINTH 25"
            >
              PLINTH 25
            </div>
            <div
              className="w-[90rem] font-cynatar mr-4 c1:text-[20rem] tracking-wide 2xl:text-[15rem] xl:text-[13rem] lg:text-[12rem] md:text-[9rem] sm:text-[8rem] xsm:text-[5rem] uxsm:text-[4.2rem] font-[400] textfamily3 z-1   plinth hero glitch layers "
              data-text="PLINTH 25"
            >
              PLINTH 25
            </div>
          </div>
          <div className="c1:text-[4rem] 2xl:text-[2.5rem] xl:text-[2.3rem] lg:text-[2rem] md:text-[1.8rem] sm:text-[1.7rem] xsm:text-[1.3rem] uxsm:text-[1.2rem]  greencolor md:mt-[6rem] uxsm:mt-[8rem] font-melete relative ">
            24-26 JAN 2025
          </div>
          <div className="flex c1:text-[3.5rem] 2xl:text-[2rem] xl:text-[1.8rem] lg:text-[1.5rem] md:text-[1.3rem] sm:text-[1.4rem] xsm:text-[0.8rem] uxsm:text-[0.7rem] text-white greycolor font-melete relative">
            <span className="greycolor">
              <IoLocationOutline className=" c1:text-[4rem] xl:text-[2.5rem] lg:text-[2rem] md:text-[2rem] sm:text-[1.5rem] xsm:text-[1.5rem] uxsm:text-[1rem]"></IoLocationOutline>
            </span>
            LNMIIT,JAIPUR
          </div>
    ...
    hover:text-[#A7F818] hover:shadow-[inset_0_0_20px_#A7F818,0_0_40px_#A7F818]"
          ...
          <div className=" uxsm:w-full absolute uxsm:right-[3.5rem] xsm:right-[5rem] md:-left-[30rem] lg:right-[10rem] xl:right-[13rem] 2xl:right-[15rem] uxl:-left-[40rem] c1:-left-[50rem] font-melete lg:mt-[8rem] md:mt-[6rem] sm:mt-[1rem] xsm:mt-[0rem] uxsm:mt-[0rem]   mb-[5rem] c1:text-[2.3rem] 2xl:text-[1.8rem] xl:text-[1.5rem] lg:text-[1.3rem] md:text-[1.1rem] sm:text-[0.9rem] uxsm:text-[0.6rem] ml-[20rem] flex justify-end items-end greycolor">
            A CYBER PARADOX
          </div>
        </div>
