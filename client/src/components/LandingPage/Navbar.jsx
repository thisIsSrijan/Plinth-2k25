...
const Navbar = () => {
  return (
<div className="text-white bg-black/5 md:backdrop-blur-none backdrop-blur-sm w-full h-[6rem] flex justify-between items-center fixed z-20 overflow-hidden rounded-lg shadow-lg">
<div className="">
