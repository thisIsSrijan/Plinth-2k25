  ...
  return (
    <div className="group relative rounded-[15px] w-[300px] h-[400px] border-[2px] border-[#A7F818] p-3 lg:w-[240px] lg:h-[350px] xl:w-[280px] xl:h-[380px] overflow-hidden transition-all duration-300 ease-in-out hover:shadow-lg hover:shadow-[#A7F818]/50 hover:scale-105">
      ...
      <div className="relative w-full h-full">
        ...
        {/* Text elements */}
        <h2 className="uppercase absolute bottom-28 left-[18px] text-[#C0C0C0FC] font-poppins font-semibold text-[20px] leading-[5px] lg:text-[15px] lg:leading-[3px] xl:text-[20px] xl:leading-[5px] transition-all duration-300 group-hover:bottom-32 group-hover:text-[#A7F818]">
          {designation}
        </h2>
        <h1 className="absolute w-[230px] h-[92px] bottom-0 left-[18px] text-white font-poppins text-[35px] font-semibold leading-[30px] text-left decoration-slice lg:text-[30px] lg:leading-[25px] lg:w-[180px] lg:h-[70px] lg:bottom-7 xl:h-[92px] xl:text-[35px] xl:leading-[30px] xl:w-[230px] xl:bottom-0 transition-all duration-300 group-hover:bottom-4">
          {name}
        </h1>
